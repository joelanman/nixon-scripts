...
module.exports = {
    ...
    steps : [
        ...
        },
        {
            name: "documents",
            js: function(){
                $('label:contains("Help me find a certified company to verify me")')[0].click();
        ...
        },
        {
            name: "create-account",
            js: function(){
                $('a:contains("Continue to Digidentity")')[0].click();
            }
        },
        {
        ...
        {
            name: "identity-test-intro",
            js: function(){
                $('button:contains("Take the identity test")')[0].click();
            }
        },
        {
            name: "identity-test-1",
            js: function(){
                $('button:contains("Continue")')[0].click();
            }
        },
        {
            name: "identity-test-2",
            js: function(){
                $('button:contains("Continue")')[0].click();
            }
        },
        {
            name: "identity-test-3",
            js: function(){
                $('button:contains("Continue")')[0].click();
            }
        },
